...
let blogName = "Helen Codes";
let authorName = "Helen Chong";
let authorLink = "https://helenclx.github.io/"; // Enter your website, social media, etc. Some way for people to tell you they like your blog! (Leaving it empty is okay too)
...
let postsArray = [
    ...
    [ "posts/2023-08-21-Welcome-to-Helen-Codes.html" ]
...
if (document.title === "Blog Post") {
    document.title = currentPostTitle + ` | Blog | Helen Chong | Front-End Web Developer`;
}